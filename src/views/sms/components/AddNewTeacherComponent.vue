  ...
  <transition name="fade">
    ...
    >
      ...
      <transition name="scale">
        <div
          v-show="modelValue"
          class="relative z-10 w-full max-w-4xl rounded-2xl bg-white shadow-2xl"
          role="dialog"
          aria-modal="true"
        >
          <div class="flex items-center justify-between border-b border-slate-100 px-6 py-4">
            <div>
              ...
              <h3 class="text-lg font-semibold text-slate-800">Teacher Information</h3>
            </div>
          ...
          <form class="grid gap-4 p-6 text-sm text-slate-600">
            ...
            <div class="grid gap-4 lg:grid-cols-2">
              <div class="space-y-2">
                <label class="text-xs font-semibold text-slate-500">Class</label>
            ...
            <div class="grid gap-4 lg:grid-cols-2">
              ...
              <div class="space-y-2">
                ...
                <input type="text" placeholder="dd / mm / yyyy" class="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2" />
              </div>
            </div>

            <div class="grid gap-4 lg:grid-cols-2">
              <div class="space-y-2">
                <label class="text-xs font-semibold text-slate-500">ID No</label>
                <input type="text" class="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2" />
              </div>
              <div class="space-y-2">
            ...
            <div class="grid gap-4 lg:grid-cols-2">
              <div class="space-y-2">
                <label class="text-xs font-semibold text-slate-500">Religion</label>
                <input type="text" class="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2" />
              </div>
              <div class="space-y-2">
                <label class="text-xs font-semibold text-slate-500">E-mail</label>
                <input type="email" class="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2" />
              </div>
            </div>

            <div class="grid gap-4 lg:grid-cols-2">
              <div class="space-y-2">
                <label class="text-xs font-semibold text-slate-500">Phone No</label>
                <input type="text" class="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2" />
              </div>
              <div class="space-y-2">
            ...
            <div class="space-y-2">
              <label class="text-xs font-semibold text-slate-500">Upload Teacher Photo (150px X 150px)</label>
              <input type="file" class="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs" />
            </div>
          </form>

          <div class="flex items-center gap-3 border-t border-slate-100 px-6 py-4">
            <button class="rounded-md bg-amber-400 px-6 py-2 text-xs font-semibold uppercase text-white">Save</button>
